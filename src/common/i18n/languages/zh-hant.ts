...
const lang: LanguageDict = {
  ...
  data_dir_invalid_message: '資料位置記錄已損毀，SwitchHosts 無法確定資料的儲存位置。你的資料未被更動。請選擇如何繼續。',
  ...
  lightweight_mode_desc: '關閉視窗時銷毀渲染處理程序以釋放記憶體，重新開啟視窗會稍慢一些。',
  line: '行',
  lines: '行',
  loading: '載入中...',
  local: '本地',
  ...
  multi_chose_folder_switch_all_desc:
    '開啟後，切換資料夾時會同時開啟或關閉其子項目；遇到單選模式資料夾時，不會繼續批量切換其中的子項目。',
  ...
  redo: '重做',
  refresh: '更新',
  refresh_remote_hosts_on_startup: '啟動時刷新遠端方案',
  refresh_remote_hosts_on_startup_desc: '開啟後，每次啟動都會自動刷新所有遠端 Hosts 方案。',
  regexp: '正規表達式',
  reload: '重載',
  remote: '遠端',
  ...
  use_proxy: '使用代理',
  use_proxy_desc: '如果開啟，下載遠端 Hosts 方案、檢查和下載應用程式更新時將使用代理進行連線。',
