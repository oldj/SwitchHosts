...
export default {
  ...
  remove_duplicate_records_desc: 'Jeśli domena wskazuje na wiele adresów IP, tylko pierwszy będzie obowiązywać, a podczas stosowania hosts pozostałe zostaną skonwertowane na komentarze.',
  replace: 'Zamień',
